...
* CloudFront / CDN Put CloudFront in front of cacheable content, especially
...
* Application caching
	...
	Example: ECS │ ├── Cache hit →
	Redis │ └── Cache miss → RDS → Redis
...
The regional differences live here rather than being hardcoded into the cell module.
